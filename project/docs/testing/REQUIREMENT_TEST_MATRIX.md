...
| FR-08 | Enforce answer time limits | UTC-02, ITC-03, FR-08 | automated-smoke + manual | `server/test/TranscriptEvaluator.smoke.test.js`, `server/test/PromptTemplates.smoke.test.js`, `server/test/SessionUpdateBuilder.smoke.test.js`, manual checklist | implemented | project team |
...
| FR-12 | Provide interviewer voice (TTS) | UTC-08, ITC-02, ITC-03 | automated-smoke + manual | `server/test/OpenAiRealtimeGateway.smoke.test.js`, `server/test/SessionUpdateBuilder.smoke.test.js`, manual checklist | implemented | project team |
...
| UIR-02 | Interview screen available | ITC-03, STC-04 | automated-smoke + manual | `project/client/src/test/App.smoke.test.tsx`, `project/client/src/test/InterviewPage.smoke.test.tsx`, manual checklist | implemented | project team |
